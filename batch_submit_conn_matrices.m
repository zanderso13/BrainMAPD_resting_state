...
scriptdir = '/projects/b1108/projects/BrainMAPD_preproc_rest_T1_only/quest_output';

file_list = filenames(fullfile(preprocdir,strcat('sub-*/ses-2/func/ssub*preproc_bold.nii')));
...
%    apply_300ROI(PID)
       ...
       '#SBATCH -t 00:30:00\n'...  
       '#SBATCH --mem=64G\n\n'...
       'matlab -nodisplay -nosplash -nodesktop -r "addpath(genpath(''' repodir ''')); apply_300ROI(' PID '); quit"\n\n'];
